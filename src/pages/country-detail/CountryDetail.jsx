  ...
  return (
    <section className="country-detail-container">
      ...
      { countrySearched.length> 0 ? (
        ...
        <img src={countrySearched[0].flags.png} alt={countrySearched[0].name.common} className="country-detail-image" />
        ...
        <div className="country-detail-right">
          ...
          <div className="border">
            ...
            { countrySearched[0].borders ? (
              ...
              <span> No borders with any country </span>)}
       ...
       ( function myFunction() {
          setTimeout(<div> No information found </div>, 3000);
        })()
